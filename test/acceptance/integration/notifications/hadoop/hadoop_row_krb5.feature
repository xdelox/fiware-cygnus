...
Feature: Stored in hadoop new notifications per row from context broker using kerberos
  As a cygnus user
  I want to be able to store in hadoop new notifications per row from context broker using kerberos
