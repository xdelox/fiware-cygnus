...
Feature: Store in mysql new notifications per row from context broker using grouping rules with patterns
  As a cygnus user
  I want to be able to store in mysql new notifications per row from context broker using grouping rules with patterns
